                        ...
                        ?>
                            ...
                            <thead class="table-success">
                              <tr>
                                ...
                                <th class="text-center" width="40%" colspan="2">Actions</th>
                              </tr>
                            </thead>
                            <tbody>
                              <?php    
                              ...
                              <tr>
                                ...
                                <td>
                                   <a href="type_agent.php?edit=<?= $donnees['Idtypeagent']; ?>" class="badge badge-success p-2">Modifier</a></td>
                                 <td>  
                                   <a href="Php/typeagent.php?delete=<?= $donnees['Idtypeagent']; ?>" class="badge badge-danger p-2" onclick="return confirm('Etes-vous sûr(e)???');">Supprimer</a>
                                </td>
                              </tr>
                              <?php } ?>
                            </tbody>
