            ...
            <section class="section">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <br/><br/>
                        <div class="row"><h2 align="center">Liste des Fonctions</h2></div>
                         <br/><br/>
                        ...
                        <?php } unset($_SESSION['message']); ?>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                   <a href="fonction.php?edit=<?= $donnees['Idfonction']; ?>" class="badge badge-success p-2">Modifier</a> | 
                                   <a href="Php/fontion.php?delete=<?= $donnees['Idfonction']; ?>" class="badge badge-danger p-2" onclick="return confirm('Etes-vous sûr(e)???');">Supprimer</a>
                                </td>
                              </tr>
                              <?php } ?>
                            </tbody>
                    	...
                    	<div class="col-5 conte">
                    		...
                    		<div class="row rows">
                    			<form action="Php/fontion.php" method="POST">
                                    ...
                                    <div class="row mb-3">
                                       ...
                                       <div class="col-sm-8">
                                             <input type="text" class="form-control" id="colFormLabel" placeholder="libellé de de la fonction" required="true" name="libfonction" value="<?= $lib; ?>">
                                       </div>
