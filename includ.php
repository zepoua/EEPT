            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="créer_cpt.php" class="dropdown-item has-icon"><i class="far fa-user"></i> Créer un compte</a>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="agents.php">Enregistrer un Agent</a></li>
                            <li class="active"><a class="nav-link" href="listeagent.php">Modifier un Agent</a></li>
                            <li><a class="nav-link" href="listeagent.php">Supprimer un Agent</a></li>
                        </ul>
                    </li>
                    <li class="menu-header">Types d'agent et etats</li>
                    <li class="dropdown">
                        <a href="type_agent.php" class="nav-link "><i class="fas fa-th"></i> <span>Gestion des Types d'Agent</span></a>
                    </li>
                    <li class="dropdown">
                        <a href="etat.php" class="nav-link "><i class="fas fa-th"></i> <span>Gestion des Etats</span></a>
                    </li>

                    <li class="menu-header">Affectations et mutations</li>
                    <li class="dropdown">
                        <a href="structure.php" class="nav-link "><i class="fas fa-th-large"></i> <span>Structure de l'EEPT</span></a>
                    </li>
                    <li class="dropdown">
                        <a href="fonction.php" class="nav-link "><i class="far fa-file-alt"></i> <span>Fonctions à l'EEPT</span></a>
                    </li>
                    <li class="dropdown">
                        <a href="affecter.php" class="nav-link"><i class="fas fa-map-marker-alt"></i> <span>Affectations</span></a>
                    </li>
                    <li class="dropdown">
                        <a href="muter.php" class="nav-link "><i class="fas fa-plug"></i> <span>Mutations</span></a>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="créer_cpt.php">Register</a></li> 
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="agent.php">STATISTIQUES</a></li>
                        </ul>
                    </li>
